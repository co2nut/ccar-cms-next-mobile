...
const KPPIndex = (props) => {
    ...
    const [showEnRevisionDrawer, setShowEnRevisionDrawer] = useState(false)
    const [showBmRevisionModal, setShowBmRevisionModal] = useState(false)
    const [showBmRevisionDrawer, setShowBmRevisionDrawer] = useState(false)
    ...
    const handlePage = () => {
        ...
        switch (tabIndex) {
            ...
            case 3:
                ...
                break;
            case 4:
                setShowEnRevisionDrawer(true);
                break;
            case 5:
                setShowBmRevisionDrawer(true);
                break;
            default:
                break;
        }
        ...
        return (
            <React.Fragment>
                <div className='relative-wrapper fill-parent'>
                    ...
                    <div className="relative-wrapper thickBorder round-border margin-top-md padding-sm " onClick={(e) => { setShowEnRevisionDrawer(true) }} style={{width:'95%', backgroundImage: `url('/assets/kpp/1.jpg')`, backgroundSize:'100%', backgroundPosition:'center' }}>
                        <div>
                    ...
                    <div className="relative-wrapper thickBorder round-border margin-top-md padding-sm" onClick={(e) => { setShowBmRevisionDrawer(true) }} style={{width:'95%', backgroundImage: `url('/assets/kpp/2.jpg')`, backgroundSize:'100%', backgroundPosition:'center'}}>
                        <div>
    ...
    return (
        <React.Fragment>
            <LayoutV2>
                ...
                <Drawer
                    className="kpp"
                    visible={showEnRevisionDrawer}
                    centered
                    footer={null}
                    closable={true}
                    onClose={(e) => { setShowEnRevisionDrawer(false) }}
                    width = {'100%'}
                >
                ...
                <Drawer
                    className="kpp"
                    visible={showBmRevisionDrawer}
                    centered
                    footer={null}
                    closable={true}
                    onClose={(e) => { setShowBmRevisionDrawer(false) }}
                    width = {'100%'}
                >
                <div className='padding-md'>
                        <Row type="flex" align="middle" gutter={[10, 20]}>
