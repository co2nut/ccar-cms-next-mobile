                        ...
                        <Col xs={4} sm={4} md={4} lg={4} xl={4}>
                            ...
                            <Col xs={20} sm={20} md={20} lg={20} xl={20}>
                                <div className="width-100 background-white" >
                                    <Tabs activeKey={videoActiveLanguage} onChange={(e) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(withRouter(SocialVideos)));
