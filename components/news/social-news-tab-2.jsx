...
import SocialNewsSkeletonBox from '../skeleton-loader/SocialNewsSkeletonBox';
...
const SocialNewTabs = (props) => {
    ...
    const _renderNewsList = (data) => {
        return (
            <div key='newsList' className="padding-x-md " style={{ height: '500px', paddingTop: authorListHeight + 10 }}>
                {
                    newsLoading ?
                        <SocialNewsSkeletonBox />
                        :
    ...
    return (
        ...
        <React.Fragment>
            <div className="flex-items-align-stretch authorList">
                <span className="d-inline-block margin-left-sm width-auto flex-items-grow-max content relative-wrapper" >
                    ...
                    <div className="width-100 flex-items-align-center" style={{ height: authorListHeight, position: 'absolute', top: 55 }}>
