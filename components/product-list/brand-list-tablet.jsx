    ...
    useEffect(() => {
        ...
        if (_.isArray(props.data) && !_.isEmpty(props.data)) {
            ...
            let brands = _.compact(_.map(props.data, function (brand) {
                ...
                if(_.isPlainObject(selectedBrand) && !_.isEmpty(selectedBrand)){
                    selectedBrand.origData = brand;
                }
...
export default connect(mapStateToProps, mapDispatchToProps)(BrandListTablet);