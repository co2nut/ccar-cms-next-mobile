                ...
                <Row className="padding-top-sm fixed-container" style={{ backgroundColor: '#ffffff' }}>
                      ...
                      <Col xs={12} sm={12} md={12} lg={10} xl={12}>
                        <Row style={{ marginTop: '9px' }}>
                          <Col xs={12} sm={12} md={12} lg={12} xl={12} style={{ padding: '0px 5px' }}>
                            <WhatsAppButton readOnly mobileNumber={this.state.productDetails} />
                          </Col>
                          <Col xs={12} sm={12} md={12} lg={12} xl={12} style={{ padding: '0px 5px' }}>
                      ...
                      <Col xs={12} sm={12} md={12} lg={14} xl={12}>
                        <div className="flex-justify-end flex-items-align-center flex-wrap" style={{ marginTop: '5px' }}>
                          <span className="d-inline-block">
                            <Wishlist readOnly type="product" productId={this.state.productDetails._id} saverId={this.props.user.authenticated ? this.props.user.info.user._id : null}
                              savedButton={
                          ...
                          <span className="d-inline-block" style={{ marginRight: '5px' }}>
                            <ShareButtonDialog readOnly title={`CCAR.my | ${this.state.productDetails.title}`} />
                          </span>
                          ...
                          <span className="d-inline-block">
                            <AddCompareProductButton readOnly data={this.state.productDetails} saveButton={() => {
                              return (
                  ...
                  <Col xs={12} sm={12} md={6} lg={6} xl={6} className="margin-y-md" style={{ marginTop: '-2px' }}>
                    <div className="thin-border" style={{ marginTop: '5px' }}>
                      <a className="grey-darken-2 font-weight-normal">
                        <Row>
                          <Col span={12}>
                ...
                <Col className="gutter-row" xs={24} sm={24} md={24} lg={18} xl={18} >
                  ...
                  <Row gutter={[20, 10]}>
                    <Col className="gutter-row" xs={24} sm={24} md={24} lg={24} xl={24}>
                      ...
                      <Row gutter={[10, 10]}>
                        <Col className="gutter-row" xs={24} sm={24} md={24} lg={24} xl={24}>
                          <Description readOnly productDetails={this.state.productDetails} />
                        </Col>
                      </Row>
                    </Col>
                  </Row>
                ...
                <Col className="gutter-row" xs={24} sm={24} md={0} lg={6} xl={6} style={{ paddingLeft: '10px', paddingRight: '10px' }} >
                  <div className="fill-parent" >
                    ...
                    <div className="background-white padding-sm thin-border">
                      ...
                      <SellerBusinessCard readOnly data={this.state.productDetails.companys} data1={this.state.productDetails.createdBy} />
                      <Row className="padding-top-sm">
                        <Col xs={12} sm={12} md={12} lg={12} xl={12} style={{ padding: '0px 5px' }}>
                          <WhatsAppButton readOnly mobileNumber={this.state.productDetails} />
                        </Col>
