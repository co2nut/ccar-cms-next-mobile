import { Button, Col, Collapse, Divider, Empty, Form, Icon, Menu, Pagination, Radio, Row, Spin, Tag, Breadcrumb, Affix, Drawer, Switch, Tooltip } from 'antd'
...
import GridProductList2 from '../GridProductList2'
...
const CarMarketPage = (props) => {
    ...
    const _renderGridViewTablet = (data) => {
        ...
        return (
            productLoading ?
                ...
                :
                _.isArray(data) && !_.isEmpty(data) ?
                    <GridProductList2 data={data} xs={24} sm={24} md={8} lg={24} xl={24}
                    renderBumpStatus={(item) => {
                        return _renderBumpStatus(item)
                        }} 
                    />
                                            ...
                                            <Row>
                                                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                                                    <div className="d-flex scroller-type"  >
                                                        {_renderGridViewTablet(notEmptyLength(productList) ? productList : [])}
                                                    </div>
                                                </Col>
                                            </Row>
                                        </Col>
