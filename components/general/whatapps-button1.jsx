                                ...
                                <span style={contactStyle}>{(v.contactNoPrefix || '') + (v.contactNo || '')}
                                    <span>
                                        <a target={'_blank'}
                                            ...
                                            <div style={{ padding: 4, background: '#25D366', borderColor: '#25D366', textAlign:'center', borderRadius:'4px'}}>
                                                <img src="/assets/profile/icon-list/carmarket-bar-icon/whatsapp.png" style={{ width: '80%' }} />
                                            </div>
                                        </a>
                                    </span>
    ...
    return (
        <span className={props.className ? props.className : null} style={props.style ? props.style : null}>
            <Default>
                ...
                <a target={!_.get(props.mobileNumber, ['createdBy', 'contactNoPrimary']) ? null : '_blank'} href={!_.get(props.mobileNumber, ['createdBy', 'contactNoPrimary']) ? null : "https://web.whatsapp.com/send?phone=" + _.get(props.mobileNumber, ['createdBy', 'contactNoPrimary']).replace('+', '') + "&text=Hi " + getUserName(_.get(props.mobileNumber, ['createdBy']), 'prefixName') + ", I am interested in your car ad on ccar.my and I would like to know more about " + props.mobileNumber.title + " (RM " + formatNumber(props.mobileNumber.price, null, false, 2, true) + "). Thank you. https://ccar.my/viewCar/" + props.mobileNumber._id} onClick={(e) => {
            ...
            <Mobile>
                ...
                {/* <a href={"https://web.whatsapp.com/send?phone=" + props.mobileNumber + "&text=Hi"} > */}
                {/* </Tooltip><a href={props.readOnly ? null : "https://web.whatsapp.com/send?phone=+60194341511&text=Hello From Ccar"}  > */}
                <a href={!_.get(props.mobileNumber, ['createdBy', 'contactNoPrimary']) ? null : "https://wa.me/" + _.get(props.mobileNumber, ['createdBy', 'contactNoPrimary']).replace('+', '') + "&text=Hi " + getUserName(_.get(props.mobileNumber, ['createdBy']), 'prefixName') + ", I am interested in your car ad on ccar.my and I would like to know more about " + props.mobileNumber.title + " (RM " + formatNumber(props.mobileNumber.price, null, false, 2, true) + "). Thank you. https://ccar.my/viewCar/" + props.mobileNumber._id} onClick={(e) => {
                    if (!_.get(props.mobileNumber, ['createdBy', 'contactNoPrimary'])) {
                        message.error('Whatsapp No Not Found')
                    }
                }}  >
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(withRouter(WhatsAppButton1)));