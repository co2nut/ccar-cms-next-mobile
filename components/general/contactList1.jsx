            ...
            <a onClick={() => { setVisible(true) }}>
                {
                    props.button ?
                        ...
                        <div style={{ padding: 5, background: '#25D366', borderColor: '#25D366', textAlign:'center', borderRadius:'4px'}}>
                           <img src="/assets/profile/icon-list/carmarket-bar-icon/call.png" style={{width:'80%'}}/>
                        </div>
                }
            </a>
            <Modal
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(ContactList1));