import { Button, Col, Drawer, Form, Icon, Input, message, Modal, Radio, Row, Spin, Tooltip, Upload } from 'antd';
            ...
            <Drawer
                ...
                title={
                    <div className="flex-justify-space-between flex-items-align-center padding-y-sm background-ccar-button-yellow">
                        ...
                        <Button type="link" className="black headline" disabled={confirmLoading} onClick={() => { onSubmit() }}>
                            {
                                props.editMode ?
                                    'Done'
                                    :
                ...
                closable={false}
            >
                <Loading spinning={confirmLoading}>
                            ...
                            <Row gutter={6}>
                                ...
                                >
                                    {imageList.map((item, idx) => (
                                        <Col key={'image' + idx} xs={6} sm={6} md={6} lg={6} style={{ maxWidth: '100%', maxHeight: '100px' }}>
                                            {item.url
                                                ?
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(withRouter(WritePostDrawer)));