...
import { loginBackground, tbh1Cny, tbh2Cny, cnyLionHead, cnyLogo, googleLogo, tbh } from '../../icon';
      ...
      >
        <div className="padding-sm round-border relative-wrapper" style={{
          ...
          <div className="wrap-register-link">
            {/* <a onClick={() => { this.props.history.push('/register'); this.props.loginMode(false) }}>Register as Business Owner </a>
