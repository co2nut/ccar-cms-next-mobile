import { Avatar, Breadcrumb, Card, Col, Form, message, Row, Divider } from 'antd';
        ...
        return menuItems.map((item, index) => {
            return (
                <a key={'path' + index} onClick={() => {
                    ...
                    <Row key={'row' + index} type="flex" align="center" justify="start" gutter={[0, 30]} key={index} >
                        <Col span={24}>
                                ...
                                <Row type="flex" justify="center" align="top" gutter={[10, 10]}>
                                    ...
                                    <Col span={24} >
                                        <div className="padding-sm">
                                            <Row>
                                                <Col span={6}>
                                                    <div style={{ 'position': 'relative' }}>
                                                        <div>
                                                            ...
                                                            <UserAvatar size={80} data={profile} avatarStyle={{ "border-color": 'black', 'border': 'solid' }} />
                                                            {
                                                                _.isPlainObject(profile) && !_.isEmpty(profile) ?
                                                                    <Avatar size={30} src={profile.facebookId ? facebookLogo : profile.googleId ? googleLogo : ccarLogo} style={{ 'position': 'absolute', top: "80%", left: "63%" }} className='background-white' />
                                                                    :
                                                                    null
                                                            }
                                                        </div>
                                                ...
                                                <Col span={18}>
                                                    <Row type="flex" className="margin-top-md margin-left-md">
                                                        <h3 style={{
                                                            'fontWeight': 'bold'
                                                        }}>{_.get(profile, ['freakId']) || ''}</h3>
                                                    </Row>
                                                    <Row type="flex" className="margin-left-md">
                                    ...
                                    <Col span={24}>
                                        <div className="d-flex" style={{overflow:'scroll'}}>
                                            {
                                            _.isArray(profileMenu) && !_.isEmpty(profileMenu) ?
                                                <div>
