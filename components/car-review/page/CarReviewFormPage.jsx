import { AutoComplete, Button, Col, Divider, Form, Icon, Input, message, Rate, Row, Tooltip, Upload } from 'antd';
...
import ReviewAttachmentBox from '../ReviewAttachmentBox';
                            ...
                            if (notEmptyLength(images)) {
                                ...
                                if (insertImages.length > 0) {
                                    ...
                                    for (let i = 0; i < insertImages.length; i++) {
                                        var fileName = v4() + "-" + insertImages[i].name.split('.').join("-") + "-" + new Date().getTime();
                            ...
                            if (notEmptyLength(videos)) {
                                ...
                                if (insertVideos.length > 0) {
                                    ...
                                    for (let i = 0; i < insertVideos.length; i++) {
                                        var fileName = v4() + "-" + insertVideos[i].name.split('.').join("-") + "-" + new Date().getTime();
            ...
            <Mobile>
                <div className="section-version3">
                    <div className="container-version3 padding-sm" style={{touchAction:'pan-y'}}>
                        <div className="flex-justify-start font-weight-bold grey-darken-1 padding-md">
                            Your review matters!
                            </div>
                        <div className="flex-justify-center flex-items-align-center padding-md">
                            <img src={ratingBanner} style={{ width: 300, height: 150 }} />
                        </div>
                        <div className="font-weight-light flex-justify-center grey-darken-1 flex-wrap text-overflow-break">
                            Do you know that your small act of kindness can help other buyers to make better decision? 
                            Share your feeling and experience about your car now!
                        </div> 

                        <div className="flex-justify-start font-weight-bold grey-darken-1 margin-top-md">
                            Select Car to Review
                         </div>
                        ...
                        <Form>
                            ...
                            <div className="font-weight-light flex-justify-start grey-darken-1 flex-wrap text-overflow-break padding-y-sm">
                                How would you rate your car on the following aspects?
                            </div>
                            ...
                            >
                                {getFieldDecorator('rating', {
                                    ...
                                    <Rate style={{ fontSize: 20 }} allowHalf />
                                )}
                            </Form.Item>
                            <div className="padding-top-md">
                                {
                            ...
                            />
                            <div className="padding-y-md">
                                <Button style={{width:'100%'}} size="large" className="padding-x-xl border-ccar-button-yellow background-ccar-button-yellow black" onClick={(e) => { handleSubmit() }}>Submit</Button>
                            </div>
                        </Form>
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(CarReviewFormPage));